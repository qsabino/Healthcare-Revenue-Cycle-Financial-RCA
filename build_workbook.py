def build_workbook():
    ...
    from scripts.utils import format_worksheet
    ...
    with pd.ExcelWriter(
        ...
        denial_df.to_excel(
            writer,
            sheet_name="Denial RCA",
            startrow=0,
            index=False
        )

        denial_trend_df.to_excel(
            writer,
            sheet_name="Denial RCA",
            startrow=15,
            index=False
